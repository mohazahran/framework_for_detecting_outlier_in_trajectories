...
#define __PYX_HAVE__myCython__cythonOptimize
#define __PYX_HAVE_API__myCython__cythonOptimize
#include <math.h>
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'myCython.cythonOptimize' */
...
static double __pyx_f_8myCython_14cythonOptimize_getLogProb(__Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
static double __pyx_f_8myCython_14cythonOptimize_evaluate(int, __Pyx_memviewslice, int, int, __Pyx_memviewslice, __Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
static double __pyx_f_8myCython_14cythonOptimize_calculateSequenceProb(__Pyx_memviewslice, int, __Pyx_memviewslice, int, int, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static double __pyx_f_8myCython_14cythonOptimize_doSum(__Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
static double __pyx_f_8myCython_14cythonOptimize_calculateSequenceProb_trpp(__Pyx_memviewslice, int, __Pyx_memviewslice, int, __Pyx_memviewslice, __Pyx_memviewslice, double, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "myCython.cythonOptimize"
int __pyx_module_is_main_myCython__cythonOptimize = 0;

/* Implementation of 'myCython.cythonOptimize' */
...
static const char __pyx_k_Psi_zss[] = "Psi_zss";
...
static const char __pyx_k_logSeqProbZ[] = "logSeqProbZ";
...
static PyObject *__pyx_n_s_Psi_zss;
...
static PyObject *__pyx_pf_8myCython_14cythonOptimize_getLogProb(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_logProbs, int __pyx_v_listLen); /* proto */
static PyObject *__pyx_pf_8myCython_14cythonOptimize_2evaluate(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_userId, __Pyx_memviewslice __pyx_v_history, int __pyx_v_historyLen, int __pyx_v_targetObjId, __Pyx_memviewslice __pyx_v_Theta_zh, __Pyx_memviewslice __pyx_v_Psi_sz, int __pyx_v_env); /* proto */
static PyObject *__pyx_pf_8myCython_14cythonOptimize_4calculateSequenceProb(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_theSequence, int __pyx_v_theSequenceLen, __Pyx_memviewslice __pyx_v_logSeqProbZ, int __pyx_v_true_mem_size, int __pyx_v_userId, __Pyx_memviewslice __pyx_v_Theta_zh, __Pyx_memviewslice __pyx_v_Psi_sz); /* proto */
static PyObject *__pyx_pf_8myCython_14cythonOptimize_6doSum(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr, int __pyx_v_size); /* proto */
static PyObject *__pyx_pf_8myCython_14cythonOptimize_8calculateSequenceProb_trpp(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_theSequence, int __pyx_v_theSequenceLen, __Pyx_memviewslice __pyx_v_logSeqProbZ, int __pyx_v_userId, __Pyx_memviewslice __pyx_v_Theta_zh, __Pyx_memviewslice __pyx_v_Psi_zss, double __pyx_v_a, int __pyx_v_s); /* proto */
...
/* "myCython/cythonOptimize.pyx":15
 * 
 * @boundscheck(False)
...
static PyObject *__pyx_pw_8myCython_14cythonOptimize_1getLogProb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_8myCython_14cythonOptimize_getLogProb(__Pyx_memviewslice __pyx_v_logProbs, int __pyx_v_listLen, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_pw;
  double __pyx_v_res;
  double __pyx_r;
  int __pyx_t_1;
  ...
  /* "myCython/cythonOptimize.pyx":16
 * @boundscheck(False)
 * cpdef double getLogProb(double[:] logProbs, int listLen) nogil:
 *     cdef double pw = 0.0             # <<<<<<<<<<<<<<
 *     cdef double res = 0.0
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":17
 * cpdef double getLogProb(double[:] logProbs, int listLen) nogil:
 *     cdef double pw = 0.0
 *     cdef double res = 0.0             # <<<<<<<<<<<<<<
 *     if(listLen == 1):
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":18
 *     cdef double pw = 0.0
 *     cdef double res = 0.0
 *     if(listLen == 1):             # <<<<<<<<<<<<<<
 *         return logProbs[0]
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "myCython/cythonOptimize.pyx":19
 *     cdef double res = 0.0
 *     if(listLen == 1):
 *         return logProbs[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":21
 *         return logProbs[0]
 * 
 *     pw = (-1)*logProbs[0] + getLogProb(logProbs[1:], (listLen-1))             # <<<<<<<<<<<<<<
 *     if(pw<100):
...
__pyx_v_pw = ((-1.0 * (*((double *) ( /* dim=0 */ (__pyx_v_logProbs.data + __pyx_t_3 * __pyx_v_logProbs.strides[0]) )))) + __pyx_f_8myCython_14cythonOptimize_getLogProb(__pyx_t_4, (__pyx_v_listLen - 1), 0));
  __PYX_XDEC_MEMVIEW(&__pyx_t_4, 0);
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "myCython/cythonOptimize.pyx":22
 * 
 *     pw = (-1)*logProbs[0] + getLogProb(logProbs[1:], (listLen-1))
 *     if(pw<100):             # <<<<<<<<<<<<<<
 *         res = logProbs[0]+log10(1+(pow(10,pw)))
 *     else:
 */
  __pyx_t_1 = ((__pyx_v_pw < 100.0) != 0);
  if (__pyx_t_1) {

    /* "myCython/cythonOptimize.pyx":23
 *     pw = (-1)*logProbs[0] + getLogProb(logProbs[1:], (listLen-1))
 *     if(pw<100):
 *         res = logProbs[0]+log10(1+(pow(10,pw)))             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    ...
    __pyx_v_res = ((*((double *) ( /* dim=0 */ (__pyx_v_logProbs.data + __pyx_t_6 * __pyx_v_logProbs.strides[0]) ))) + log10((1.0 + pow(10.0, __pyx_v_pw))));
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":25
 *         res = logProbs[0]+log10(1+(pow(10,pw)))
 *     else:
 *         res = logProbs[0]+pw             # <<<<<<<<<<<<<<
 *     '''
 ...
 */
  /*else*/ {
    __pyx_t_7 = 0;
    if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_logProbs.shape[0];
    __pyx_v_res = ((*((double *) ( /* dim=0 */ (__pyx_v_logProbs.data + __pyx_t_7 * __pyx_v_logProbs.strides[0]) ))) + __pyx_v_pw);
  }
  __pyx_L4:;

  /* "myCython/cythonOptimize.pyx":33
 *     '''
 * 
 *     return res             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_L1_error:;
  __PYX_XDEC_MEMVIEW(&__pyx_t_4, 0);
  __Pyx_WriteUnraisable("myCython.cythonOptimize.getLogProb", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_8myCython_14cythonOptimize_1getLogProb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8myCython_14cythonOptimize_1getLogProb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("getLogProb (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_listLen)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("getLogProb", 1, 2, 2, 1); __PYX_ERR(0, 15, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "getLogProb") < 0)) __PYX_ERR(0, 15, __pyx_L3_error)
      }
    ...
    __pyx_v_logProbs = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0]); if (unlikely(!__pyx_v_logProbs.memview)) __PYX_ERR(0, 15, __pyx_L3_error)
    __pyx_v_listLen = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_listLen == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("getLogProb", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 15, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("myCython.cythonOptimize.getLogProb", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8myCython_14cythonOptimize_getLogProb(__pyx_self, __pyx_v_logProbs, __pyx_v_listLen);
...
static PyObject *__pyx_pf_8myCython_14cythonOptimize_getLogProb(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_logProbs, int __pyx_v_listLen) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("getLogProb", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_logProbs.memview)) { __Pyx_RaiseUnboundLocalError("logProbs"); __PYX_ERR(0, 15, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_8myCython_14cythonOptimize_getLogProb(__pyx_v_logProbs, __pyx_v_listLen, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
...
/* "myCython/cythonOptimize.pyx":36
 * 
 * @boundscheck(False)
...
static PyObject *__pyx_pw_8myCython_14cythonOptimize_3evaluate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_8myCython_14cythonOptimize_evaluate(int __pyx_v_userId, __Pyx_memviewslice __pyx_v_history, int __pyx_v_historyLen, int __pyx_v_targetObjId, __Pyx_memviewslice __pyx_v_Theta_zh, __Pyx_memviewslice __pyx_v_Psi_sz, int __pyx_v_env, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "myCython/cythonOptimize.pyx":37
 * @boundscheck(False)
 * cpdef double evaluate(int userId, int[:] history, int historyLen, int targetObjId, double[:, ::1] Theta_zh, double[:, ::1] Psi_sz, int env) nogil:
 *     cdef double mem_factor = 0.0             # <<<<<<<<<<<<<<
 *     cdef double candidateProb = 0.0
 *     cdef int j = 0
 */
  __pyx_v_mem_factor = 0.0;

  /* "myCython/cythonOptimize.pyx":38
 * cpdef double evaluate(int userId, int[:] history, int historyLen, int targetObjId, double[:, ::1] Theta_zh, double[:, ::1] Psi_sz, int env) nogil:
 *     cdef double mem_factor = 0.0
 *     cdef double candidateProb = 0.0             # <<<<<<<<<<<<<<
 *     cdef int j = 0
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":39
 *     cdef double mem_factor = 0.0
 *     cdef double candidateProb = 0.0
 *     cdef int j = 0             # <<<<<<<<<<<<<<
 *     for j in xrange(historyLen):#for all B
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":40
 *     cdef double candidateProb = 0.0
 *     cdef int j = 0
 *     for j in xrange(historyLen):#for all B             # <<<<<<<<<<<<<<
 *         #i.e. multiply all psi[objid1,z]*psi[objid2,z]*..psi[objidB,z]
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "myCython/cythonOptimize.pyx":42
 *     for j in xrange(historyLen):#for all B
 *         #i.e. multiply all psi[objid1,z]*psi[objid2,z]*..psi[objidB,z]
 *         mem_factor += log10(Psi_sz[history[j], env]) # Psi[objId, env z]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_v_mem_factor = (__pyx_v_mem_factor + log10((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_Psi_sz.data + __pyx_t_4 * __pyx_v_Psi_sz.strides[0]) )) + __pyx_t_5)) )))));
  }

  /* "myCython/cythonOptimize.pyx":44
 *         mem_factor += log10(Psi_sz[history[j], env]) # Psi[objId, env z]
 *     #mem_factor *= 1.0 / (1 - Psi_sz[history[len(history)-1], env])# 1-Psi_sz[mem[B-1],z] == 1-psi_sz[objIdB,z]
 *     candidateProb = mem_factor + log10(Psi_sz[targetObjId, env]) + log10(Theta_zh[env, userId])             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_v_candidateProb = ((__pyx_v_mem_factor + log10((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_Psi_sz.data + __pyx_t_6 * __pyx_v_Psi_sz.strides[0]) )) + __pyx_t_7)) ))))) + log10((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_Theta_zh.data + __pyx_t_8 * __pyx_v_Theta_zh.strides[0]) )) + __pyx_t_9)) )))));

  /* "myCython/cythonOptimize.pyx":45
 *     #mem_factor *= 1.0 / (1 - Psi_sz[history[len(history)-1], env])# 1-Psi_sz[mem[B-1],z] == 1-psi_sz[objIdB,z]
 *     candidateProb = mem_factor + log10(Psi_sz[targetObjId, env]) + log10(Theta_zh[env, userId])
 *     return candidateProb             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_8myCython_14cythonOptimize_3evaluate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8myCython_14cythonOptimize_3evaluate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_userId;
  ...
  __Pyx_RefNannySetupContext("evaluate (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_history)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, 1); __PYX_ERR(0, 36, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_historyLen)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, 2); __PYX_ERR(0, 36, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_targetObjId)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, 3); __PYX_ERR(0, 36, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Theta_zh)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, 4); __PYX_ERR(0, 36, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Psi_sz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, 5); __PYX_ERR(0, 36, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_env)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, 6); __PYX_ERR(0, 36, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "evaluate") < 0)) __PYX_ERR(0, 36, __pyx_L3_error)
      }
    ...
    __pyx_v_userId = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_userId == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L3_error)
    __pyx_v_history = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1]); if (unlikely(!__pyx_v_history.memview)) __PYX_ERR(0, 36, __pyx_L3_error)
    __pyx_v_historyLen = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_historyLen == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L3_error)
    __pyx_v_targetObjId = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_targetObjId == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L3_error)
    __pyx_v_Theta_zh = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[4]); if (unlikely(!__pyx_v_Theta_zh.memview)) __PYX_ERR(0, 36, __pyx_L3_error)
    __pyx_v_Psi_sz = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[5]); if (unlikely(!__pyx_v_Psi_sz.memview)) __PYX_ERR(0, 36, __pyx_L3_error)
    __pyx_v_env = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_env == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("evaluate", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 36, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("myCython.cythonOptimize.evaluate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8myCython_14cythonOptimize_2evaluate(__pyx_self, __pyx_v_userId, __pyx_v_history, __pyx_v_historyLen, __pyx_v_targetObjId, __pyx_v_Theta_zh, __pyx_v_Psi_sz, __pyx_v_env);
...
static PyObject *__pyx_pf_8myCython_14cythonOptimize_2evaluate(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_userId, __Pyx_memviewslice __pyx_v_history, int __pyx_v_historyLen, int __pyx_v_targetObjId, __Pyx_memviewslice __pyx_v_Theta_zh, __Pyx_memviewslice __pyx_v_Psi_sz, int __pyx_v_env) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("evaluate", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_history.memview)) { __Pyx_RaiseUnboundLocalError("history"); __PYX_ERR(0, 36, __pyx_L1_error) }
  if (unlikely(!__pyx_v_Theta_zh.memview)) { __Pyx_RaiseUnboundLocalError("Theta_zh"); __PYX_ERR(0, 36, __pyx_L1_error) }
  if (unlikely(!__pyx_v_Psi_sz.memview)) { __Pyx_RaiseUnboundLocalError("Psi_sz"); __PYX_ERR(0, 36, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_8myCython_14cythonOptimize_evaluate(__pyx_v_userId, __pyx_v_history, __pyx_v_historyLen, __pyx_v_targetObjId, __pyx_v_Theta_zh, __pyx_v_Psi_sz, __pyx_v_env, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "myCython/cythonOptimize.pyx":48
 * 
 * @boundscheck(False)
...
static PyObject *__pyx_pw_8myCython_14cythonOptimize_5calculateSequenceProb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_8myCython_14cythonOptimize_calculateSequenceProb(__Pyx_memviewslice __pyx_v_theSequence, int __pyx_v_theSequenceLen, __Pyx_memviewslice __pyx_v_logSeqProbZ, int __pyx_v_true_mem_size, int __pyx_v_userId, __Pyx_memviewslice __pyx_v_Theta_zh, __Pyx_memviewslice __pyx_v_Psi_sz, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "myCython/cythonOptimize.pyx":49
 * @boundscheck(False)
 * cpdef double calculateSequenceProb(int[:] theSequence, int theSequenceLen, double[:] logSeqProbZ, int true_mem_size, int userId, double[:, ::1] Theta_zh, double[:, ::1] Psi_sz) nogil:
 *     cdef double seqProb = 0.0             # <<<<<<<<<<<<<<
 *     cdef double seqProbZ = 1.0
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":50
 * cpdef double calculateSequenceProb(int[:] theSequence, int theSequenceLen, double[:] logSeqProbZ, int true_mem_size, int userId, double[:, ::1] Theta_zh, double[:, ::1] Psi_sz) nogil:
 *     cdef double seqProb = 0.0
 *     cdef double seqProbZ = 1.0             # <<<<<<<<<<<<<<
 *     cdef int targetObjId = -1
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":51
 *     cdef double seqProb = 0.0
 *     cdef double seqProbZ = 1.0
 *     cdef int targetObjId = -1             # <<<<<<<<<<<<<<
 *     cdef double prior = 0.0
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":52
 *     cdef double seqProbZ = 1.0
 *     cdef int targetObjId = -1
 *     cdef double prior = 0.0             # <<<<<<<<<<<<<<
 *     cdef double candProb = 0.0
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":53
 *     cdef int targetObjId = -1
 *     cdef double prior = 0.0
 *     cdef double candProb = 0.0             # <<<<<<<<<<<<<<
 *     cdef int window = 0
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":54
 *     cdef double prior = 0.0
 *     cdef double candProb = 0.0
 *     cdef int window = 0             # <<<<<<<<<<<<<<
 *     #cdef int[:] history = np.zeros(theSequenceLen, dtype='i4')
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":57
 *     #cdef int[:] history = np.zeros(theSequenceLen, dtype='i4')
 *     cdef int[:] history
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":58
 *     cdef int[:] history
 *     cdef int historyLen = 0
 *     cdef int targetObjIdx, z, i = 0             # <<<<<<<<<<<<<<
 *     cdef int wmax = 0
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":59
 *     cdef int historyLen = 0
 *     cdef int targetObjIdx, z, i = 0
 *     cdef int wmax = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":61
 *     cdef int wmax = 0
 * 
 *     window = min(true_mem_size, theSequenceLen)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":62
 * 
 *     window = min(true_mem_size, theSequenceLen)
 *     for z in xrange(Psi_sz.shape[1]): #for envs             # <<<<<<<<<<<<<<
 *         seqProbZ = 0.0
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_4; __pyx_t_3+=1) {
    ...
    /* "myCython/cythonOptimize.pyx":63
 *     window = min(true_mem_size, theSequenceLen)
 *     for z in xrange(Psi_sz.shape[1]): #for envs
 *         seqProbZ = 0.0             # <<<<<<<<<<<<<<
 *         for targetObjIdx in range(0,theSequenceLen): #targetObjIdx=0 cannot be predicted we have to skip it
 ...
 */
    ...
    /* "myCython/cythonOptimize.pyx":64
 *     for z in xrange(Psi_sz.shape[1]): #for envs
 *         seqProbZ = 0.0
 *         for targetObjIdx in range(0,theSequenceLen): #targetObjIdx=0 cannot be predicted we have to skip it             # <<<<<<<<<<<<<<
 *             if(targetObjIdx == 0):
 ...
 */
    ...
    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
      ...
      /* "myCython/cythonOptimize.pyx":65
 *         seqProbZ = 0.0
 *         for targetObjIdx in range(0,theSequenceLen): #targetObjIdx=0 cannot be predicted we have to skip it
 *             if(targetObjIdx == 0):             # <<<<<<<<<<<<<<
 *                 targetObjId = theSequence[targetObjIdx]
 ...
 */
      ...
      if (__pyx_t_5) {
        ...
        /* "myCython/cythonOptimize.pyx":66
 *         for targetObjIdx in range(0,theSequenceLen): #targetObjIdx=0 cannot be predicted we have to skip it
 *             if(targetObjIdx == 0):
 *                 targetObjId = theSequence[targetObjIdx]             # <<<<<<<<<<<<<<
 *                 prior = Psi_sz[targetObjId, z]
 ...
 */
        ...
        /* "myCython/cythonOptimize.pyx":67
 *             if(targetObjIdx == 0):
 *                 targetObjId = theSequence[targetObjIdx]
 *                 prior = Psi_sz[targetObjId, z]             # <<<<<<<<<<<<<<
 *                 seqProbZ += log10(prior)
 ...
 */
        ...
        /* "myCython/cythonOptimize.pyx":68
 *                 targetObjId = theSequence[targetObjIdx]
 *                 prior = Psi_sz[targetObjId, z]
 *                 seqProbZ += log10(prior)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "myCython/cythonOptimize.pyx":70
 *                 seqProbZ += log10(prior)
 *             else:
 *                 targetObjId = theSequence[targetObjIdx]             # <<<<<<<<<<<<<<
 ...
 */
      /*else*/ {
        ...
        /* "myCython/cythonOptimize.pyx":71
 *             else:
 *                 targetObjId = theSequence[targetObjIdx]
 *                 wmax = max(0,targetObjIdx-window)             # <<<<<<<<<<<<<<
 *                 history = theSequence[wmax: targetObjIdx] # look back 'window' actions.
 ...
 */
        ...
        /* "myCython/cythonOptimize.pyx":72
 *                 targetObjId = theSequence[targetObjIdx]
 *                 wmax = max(0,targetObjIdx-window)
 *                 history = theSequence[wmax: targetObjIdx] # look back 'window' actions.             # <<<<<<<<<<<<<<
 *                 historyLen = targetObjIdx-wmax
...
__PYX_XDEC_MEMVIEW(&__pyx_v_history, 0);
        ...
        /* "myCython/cythonOptimize.pyx":73
 *                 wmax = max(0,targetObjIdx-window)
 *                 history = theSequence[wmax: targetObjIdx] # look back 'window' actions.
 *                 historyLen = targetObjIdx-wmax             # <<<<<<<<<<<<<<
 *                 candProb = evaluate(userId, history, historyLen, targetObjId, Theta_zh, Psi_sz, z) #(int[:, ::1] HOs, double[:, ::1] Theta_zh, double[:, ::1] Psi_sz, int[::1] count_z, int env):
 ...
 */
        ...
        /* "myCython/cythonOptimize.pyx":74
 *                 history = theSequence[wmax: targetObjIdx] # look back 'window' actions.
 *                 historyLen = targetObjIdx-wmax
 *                 candProb = evaluate(userId, history, historyLen, targetObjId, Theta_zh, Psi_sz, z) #(int[:, ::1] HOs, double[:, ::1] Theta_zh, double[:, ::1] Psi_sz, int[::1] count_z, int env):             # <<<<<<<<<<<<<<
 *                 seqProbZ += candProb
 ...
 */
        __pyx_v_candProb = __pyx_f_8myCython_14cythonOptimize_evaluate(__pyx_v_userId, __pyx_v_history, __pyx_v_historyLen, __pyx_v_targetObjId, __pyx_v_Theta_zh, __pyx_v_Psi_sz, __pyx_v_z, 0);

        /* "myCython/cythonOptimize.pyx":75
 *                 historyLen = targetObjIdx-wmax
 *                 candProb = evaluate(userId, history, historyLen, targetObjId, Theta_zh, Psi_sz, z) #(int[:, ::1] HOs, double[:, ::1] Theta_zh, double[:, ::1] Psi_sz, int[::1] count_z, int env):
 *                 seqProbZ += candProb             # <<<<<<<<<<<<<<
 *         logSeqProbZ[z] = seqProbZ
 ...
 */
    ...
    /* "myCython/cythonOptimize.pyx":76
 *                 candProb = evaluate(userId, history, historyLen, targetObjId, Theta_zh, Psi_sz, z) #(int[:, ::1] HOs, double[:, ::1] Theta_zh, double[:, ::1] Psi_sz, int[::1] count_z, int env):
 *                 seqProbZ += candProb
 *         logSeqProbZ[z] = seqProbZ             # <<<<<<<<<<<<<<
 *         #seqProb += seqProbZ
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":79
 *         #seqProb += seqProbZ
 *     #return logSeqProbZ
 ...
 * 
 */
  __pyx_r = __pyx_f_8myCython_14cythonOptimize_getLogProb(__pyx_v_logSeqProbZ, (__pyx_v_Psi_sz.shape[1]), 0);
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_WriteUnraisable("myCython.cythonOptimize.calculateSequenceProb", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_history, 0);
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_8myCython_14cythonOptimize_5calculateSequenceProb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8myCython_14cythonOptimize_5calculateSequenceProb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("calculateSequenceProb (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_theSequenceLen)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb", 1, 7, 7, 1); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_logSeqProbZ)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb", 1, 7, 7, 2); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_true_mem_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb", 1, 7, 7, 3); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_userId)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb", 1, 7, 7, 4); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Theta_zh)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb", 1, 7, 7, 5); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Psi_sz)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb", 1, 7, 7, 6); __PYX_ERR(0, 48, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calculateSequenceProb") < 0)) __PYX_ERR(0, 48, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 7) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_theSequence = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0]); if (unlikely(!__pyx_v_theSequence.memview)) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_theSequenceLen = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_theSequenceLen == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_logSeqProbZ = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2]); if (unlikely(!__pyx_v_logSeqProbZ.memview)) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_true_mem_size = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_true_mem_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_userId = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_userId == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_Theta_zh = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[5]); if (unlikely(!__pyx_v_Theta_zh.memview)) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_Psi_sz = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[6]); if (unlikely(!__pyx_v_Psi_sz.memview)) __PYX_ERR(0, 48, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calculateSequenceProb", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 48, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("myCython.cythonOptimize.calculateSequenceProb", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8myCython_14cythonOptimize_4calculateSequenceProb(__pyx_self, __pyx_v_theSequence, __pyx_v_theSequenceLen, __pyx_v_logSeqProbZ, __pyx_v_true_mem_size, __pyx_v_userId, __pyx_v_Theta_zh, __pyx_v_Psi_sz);
...
static PyObject *__pyx_pf_8myCython_14cythonOptimize_4calculateSequenceProb(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_theSequence, int __pyx_v_theSequenceLen, __Pyx_memviewslice __pyx_v_logSeqProbZ, int __pyx_v_true_mem_size, int __pyx_v_userId, __Pyx_memviewslice __pyx_v_Theta_zh, __Pyx_memviewslice __pyx_v_Psi_sz) {
  ...
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_theSequence.memview)) { __Pyx_RaiseUnboundLocalError("theSequence"); __PYX_ERR(0, 48, __pyx_L1_error) }
  if (unlikely(!__pyx_v_logSeqProbZ.memview)) { __Pyx_RaiseUnboundLocalError("logSeqProbZ"); __PYX_ERR(0, 48, __pyx_L1_error) }
  if (unlikely(!__pyx_v_Theta_zh.memview)) { __Pyx_RaiseUnboundLocalError("Theta_zh"); __PYX_ERR(0, 48, __pyx_L1_error) }
  if (unlikely(!__pyx_v_Psi_sz.memview)) { __Pyx_RaiseUnboundLocalError("Psi_sz"); __PYX_ERR(0, 48, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_8myCython_14cythonOptimize_calculateSequenceProb(__pyx_v_theSequence, __pyx_v_theSequenceLen, __pyx_v_logSeqProbZ, __pyx_v_true_mem_size, __pyx_v_userId, __pyx_v_Theta_zh, __pyx_v_Psi_sz, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "myCython/cythonOptimize.pyx":83
 * 
 * @boundscheck(False)
...
static PyObject *__pyx_pw_8myCython_14cythonOptimize_7doSum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_8myCython_14cythonOptimize_doSum(__Pyx_memviewslice __pyx_v_arr, int __pyx_v_size, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_acc;
  long __pyx_v_i;
  double __pyx_r;
  int __pyx_t_1;
  ...
  /* "myCython/cythonOptimize.pyx":84
 * @boundscheck(False)
 * cpdef double doSum(double[:] arr, int size) nogil:
 *     cdef double acc = 0.0             # <<<<<<<<<<<<<<
 *     for i in xrange(0,size):
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":85
 * cpdef double doSum(double[:] arr, int size) nogil:
 *     cdef double acc = 0.0
 *     for i in xrange(0,size):             # <<<<<<<<<<<<<<
 *         acc = acc + arr[i]
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "myCython/cythonOptimize.pyx":86
 *     cdef double acc = 0.0
 *     for i in xrange(0,size):
 *         acc = acc + arr[i]             # <<<<<<<<<<<<<<
 *     return acc
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    if (__pyx_t_3 < 0) __pyx_t_3 += __pyx_v_arr.shape[0];
    __pyx_v_acc = (__pyx_v_acc + (*((double *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_3 * __pyx_v_arr.strides[0]) ))));
  }

  /* "myCython/cythonOptimize.pyx":87
 *     for i in xrange(0,size):
 *         acc = acc + arr[i]
 *     return acc             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_8myCython_14cythonOptimize_7doSum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8myCython_14cythonOptimize_7doSum(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_arr = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_size;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("doSum (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_size)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("doSum", 1, 2, 2, 1); __PYX_ERR(0, 83, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "doSum") < 0)) __PYX_ERR(0, 83, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_arr = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0]); if (unlikely(!__pyx_v_arr.memview)) __PYX_ERR(0, 83, __pyx_L3_error)
    __pyx_v_size = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 83, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("doSum", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 83, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("myCython.cythonOptimize.doSum", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8myCython_14cythonOptimize_6doSum(__pyx_self, __pyx_v_arr, __pyx_v_size);
...
static PyObject *__pyx_pf_8myCython_14cythonOptimize_6doSum(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr, int __pyx_v_size) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("doSum", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_arr.memview)) { __Pyx_RaiseUnboundLocalError("arr"); __PYX_ERR(0, 83, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_8myCython_14cythonOptimize_doSum(__pyx_v_arr, __pyx_v_size, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "myCython/cythonOptimize.pyx":90
 * 
 * @boundscheck(False)
...
static PyObject *__pyx_pw_8myCython_14cythonOptimize_9calculateSequenceProb_trpp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_8myCython_14cythonOptimize_calculateSequenceProb_trpp(__Pyx_memviewslice __pyx_v_theSequence, int __pyx_v_theSequenceLen, __Pyx_memviewslice __pyx_v_logSeqProbZ, int __pyx_v_userId, __Pyx_memviewslice __pyx_v_Theta_zh, __Pyx_memviewslice __pyx_v_Psi_zss, double __pyx_v_a, int __pyx_v_s, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_envCount;
  double __pyx_v_seqProbZ;
  int __pyx_v_src;
  int __pyx_v_dest;
  double __pyx_v_prob;
  ...
  /* "myCython/cythonOptimize.pyx":91
 * @boundscheck(False)
 * cpdef double calculateSequenceProb_trpp(int[:] theSequence, int theSequenceLen, double[:] logSeqProbZ, int userId, double[:, :] Theta_zh, double[:, :, :] Psi_zss, double a, int s) nogil:
 *     cdef int envCount = Theta_zh.shape[0]             # <<<<<<<<<<<<<<
 *     cdef double seqProbZ = 0.0
 *     cdef int src = -1
 */
  __pyx_v_envCount = (__pyx_v_Theta_zh.shape[0]);

  /* "myCython/cythonOptimize.pyx":92
 * cpdef double calculateSequenceProb_trpp(int[:] theSequence, int theSequenceLen, double[:] logSeqProbZ, int userId, double[:, :] Theta_zh, double[:, :, :] Psi_zss, double a, int s) nogil:
 *     cdef int envCount = Theta_zh.shape[0]
 *     cdef double seqProbZ = 0.0             # <<<<<<<<<<<<<<
 *     cdef int src = -1
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":93
 *     cdef int envCount = Theta_zh.shape[0]
 *     cdef double seqProbZ = 0.0
 *     cdef int src = -1             # <<<<<<<<<<<<<<
 *     cdef int dest = -1
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":94
 *     cdef double seqProbZ = 0.0
 *     cdef int src = -1
 *     cdef int dest = -1             # <<<<<<<<<<<<<<
 *     cdef double prob = 0.0
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":95
 *     cdef int src = -1
 *     cdef int dest = -1
 *     cdef double prob = 0.0             # <<<<<<<<<<<<<<
 *     cdef double norm = 0.0
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":96
 *     cdef int dest = -1
 *     cdef double prob = 0.0
 *     cdef double norm = 0.0             # <<<<<<<<<<<<<<
 *     cdef int nexti = 0
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":97
 *     cdef double prob = 0.0
 *     cdef double norm = 0.0
 *     cdef int nexti = 0             # <<<<<<<<<<<<<<
 *     cdef int oneLessSeqLen = theSequenceLen - 1
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":98
 *     cdef double norm = 0.0
 *     cdef int nexti = 0
 *     cdef int oneLessSeqLen = theSequenceLen - 1             # <<<<<<<<<<<<<<
 *     cdef int i,z = 0
 ...
 */
  __pyx_v_oneLessSeqLen = (__pyx_v_theSequenceLen - 1);

  /* "myCython/cythonOptimize.pyx":99
 *     cdef int nexti = 0
 *     cdef int oneLessSeqLen = theSequenceLen - 1
 *     cdef int i,z = 0             # <<<<<<<<<<<<<<
 *     for z in xrange(envCount):
 ...
 */
  ...
  /* "myCython/cythonOptimize.pyx":100
 *     cdef int oneLessSeqLen = theSequenceLen - 1
 *     cdef int i,z = 0
 *     for z in xrange(envCount):             # <<<<<<<<<<<<<<
 *         seqProbZ = log10(Theta_zh[z, userId])
 ...
 */
  __pyx_t_1 = __pyx_v_envCount;
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    __pyx_v_z = __pyx_t_2;

    /* "myCython/cythonOptimize.pyx":101
 *     cdef int i,z = 0
 *     for z in xrange(envCount):
 *         seqProbZ = log10(Theta_zh[z, userId])             # <<<<<<<<<<<<<<
 *         for i in range(0, oneLessSeqLen):
 ...
 */
    __pyx_t_3 = __pyx_v_z;
    __pyx_t_4 = __pyx_v_userId;
    if (__pyx_t_3 < 0) __pyx_t_3 += __pyx_v_Theta_zh.shape[0];
    if (__pyx_t_4 < 0) __pyx_t_4 += __pyx_v_Theta_zh.shape[1];
    __pyx_v_seqProbZ = log10((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Theta_zh.data + __pyx_t_3 * __pyx_v_Theta_zh.strides[0]) ) + __pyx_t_4 * __pyx_v_Theta_zh.strides[1]) ))));

    /* "myCython/cythonOptimize.pyx":102
 *     for z in xrange(envCount):
 *         seqProbZ = log10(Theta_zh[z, userId])
 *         for i in range(0, oneLessSeqLen):             # <<<<<<<<<<<<<<
 *             nexti = i+1
 *             src = theSequence[i]
 */
    __pyx_t_5 = __pyx_v_oneLessSeqLen;
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_i = __pyx_t_6;

      /* "myCython/cythonOptimize.pyx":103
 *         seqProbZ = log10(Theta_zh[z, userId])
 *         for i in range(0, oneLessSeqLen):
 *             nexti = i+1             # <<<<<<<<<<<<<<
 *             src = theSequence[i]
 ...
 */
      ...
      /* "myCython/cythonOptimize.pyx":104
 *         for i in range(0, oneLessSeqLen):
 *             nexti = i+1
 *             src = theSequence[i]             # <<<<<<<<<<<<<<
 *             dest = theSequence[nexti]
 ...
 */
      __pyx_t_7 = __pyx_v_i;
      if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_theSequence.shape[0];
      __pyx_v_src = (*((int *) ( /* dim=0 */ (__pyx_v_theSequence.data + __pyx_t_7 * __pyx_v_theSequence.strides[0]) )));

      /* "myCython/cythonOptimize.pyx":105
 *             nexti = i+1
 *             src = theSequence[i]
 *             dest = theSequence[nexti]             # <<<<<<<<<<<<<<
 *             norm = doSum(Psi_zss[z,src], s)
 ...
 */
      __pyx_t_8 = __pyx_v_nexti;
      if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_v_theSequence.shape[0];
      __pyx_v_dest = (*((int *) ( /* dim=0 */ (__pyx_v_theSequence.data + __pyx_t_8 * __pyx_v_theSequence.strides[0]) )));

      /* "myCython/cythonOptimize.pyx":106
 *             src = theSequence[i]
 *             dest = theSequence[nexti]
 *             norm = doSum(Psi_zss[z,src], s)             # <<<<<<<<<<<<<<
 *             prob = (Psi_zss[z, src, dest] + a) / (norm + a*s)
 *             seqProbZ += log10(prob)
 */
      __pyx_t_9.data = __pyx_v_Psi_zss.data;
      __pyx_t_9.memview = __pyx_v_Psi_zss.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_9, 0);
      {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_z;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_Psi_zss.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_Psi_zss.strides[0];
...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_src;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_Psi_zss.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_Psi_zss.strides[1];
    if (1 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (0 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
            #ifdef WITH_THREAD
...
__pyx_t_9.shape[0] = __pyx_v_Psi_zss.shape[2];
__pyx_t_9.strides[0] = __pyx_v_Psi_zss.strides[2];
    __pyx_t_9.suboffsets[0] = -1;

__pyx_v_norm = __pyx_f_8myCython_14cythonOptimize_doSum(__pyx_t_9, __pyx_v_s, 0);
      __PYX_XDEC_MEMVIEW(&__pyx_t_9, 0);
      __pyx_t_9.memview = NULL;
      __pyx_t_9.data = NULL;

      /* "myCython/cythonOptimize.pyx":107
 *             dest = theSequence[nexti]
 *             norm = doSum(Psi_zss[z,src], s)
 *             prob = (Psi_zss[z, src, dest] + a) / (norm + a*s)             # <<<<<<<<<<<<<<
 *             seqProbZ += log10(prob)
 ...
 */
      ...
      if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_Psi_zss.shape[0];
      if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_Psi_zss.shape[1];
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_Psi_zss.shape[2];
      __pyx_t_13 = ((*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Psi_zss.data + __pyx_t_10 * __pyx_v_Psi_zss.strides[0]) ) + __pyx_t_11 * __pyx_v_Psi_zss.strides[1]) ) + __pyx_t_12 * __pyx_v_Psi_zss.strides[2]) ))) + __pyx_v_a);
      __pyx_t_14 = (__pyx_v_norm + (__pyx_v_a * __pyx_v_s));
      ...
      /* "myCython/cythonOptimize.pyx":108
 *             norm = doSum(Psi_zss[z,src], s)
 *             prob = (Psi_zss[z, src, dest] + a) / (norm + a*s)
 *             seqProbZ += log10(prob)             # <<<<<<<<<<<<<<
 *         logSeqProbZ[z] = seqProbZ
 ...
 */
      __pyx_v_seqProbZ = (__pyx_v_seqProbZ + log10(__pyx_v_prob));
    }

    /* "myCython/cythonOptimize.pyx":109
 *             prob = (Psi_zss[z, src, dest] + a) / (norm + a*s)
 *             seqProbZ += log10(prob)
 *         logSeqProbZ[z] = seqProbZ             # <<<<<<<<<<<<<<
 *     return getLogProb(logSeqProbZ, envCount)
 ...
 */
    ...
    if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_logSeqProbZ.shape[0];
    *((double *) ( /* dim=0 */ (__pyx_v_logSeqProbZ.data + __pyx_t_15 * __pyx_v_logSeqProbZ.strides[0]) )) = __pyx_v_seqProbZ;
  }

  /* "myCython/cythonOptimize.pyx":110
 *             seqProbZ += log10(prob)
 *         logSeqProbZ[z] = seqProbZ
 *     return getLogProb(logSeqProbZ, envCount)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_r = __pyx_f_8myCython_14cythonOptimize_getLogProb(__pyx_v_logSeqProbZ, __pyx_v_envCount, 0);
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_L1_error:;
  __PYX_XDEC_MEMVIEW(&__pyx_t_9, 0);
  __Pyx_WriteUnraisable("myCython.cythonOptimize.calculateSequenceProb_trpp", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_8myCython_14cythonOptimize_9calculateSequenceProb_trpp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8myCython_14cythonOptimize_9calculateSequenceProb_trpp(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_theSequence = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_theSequenceLen;
  __Pyx_memviewslice __pyx_v_logSeqProbZ = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_userId;
  __Pyx_memviewslice __pyx_v_Theta_zh = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_Psi_zss = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_a;
  int __pyx_v_s;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("calculateSequenceProb_trpp (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_theSequence,&__pyx_n_s_theSequenceLen,&__pyx_n_s_logSeqProbZ,&__pyx_n_s_userId,&__pyx_n_s_Theta_zh,&__pyx_n_s_Psi_zss,&__pyx_n_s_a,&__pyx_n_s_s,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_theSequenceLen)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb_trpp", 1, 8, 8, 1); __PYX_ERR(0, 90, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_logSeqProbZ)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb_trpp", 1, 8, 8, 2); __PYX_ERR(0, 90, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_userId)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb_trpp", 1, 8, 8, 3); __PYX_ERR(0, 90, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Theta_zh)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb_trpp", 1, 8, 8, 4); __PYX_ERR(0, 90, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Psi_zss)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb_trpp", 1, 8, 8, 5); __PYX_ERR(0, 90, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb_trpp", 1, 8, 8, 6); __PYX_ERR(0, 90, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_s)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculateSequenceProb_trpp", 1, 8, 8, 7); __PYX_ERR(0, 90, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calculateSequenceProb_trpp") < 0)) __PYX_ERR(0, 90, __pyx_L3_error)
      }
    ...
    __pyx_v_theSequence = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0]); if (unlikely(!__pyx_v_theSequence.memview)) __PYX_ERR(0, 90, __pyx_L3_error)
    __pyx_v_theSequenceLen = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_theSequenceLen == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 90, __pyx_L3_error)
    __pyx_v_logSeqProbZ = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2]); if (unlikely(!__pyx_v_logSeqProbZ.memview)) __PYX_ERR(0, 90, __pyx_L3_error)
    __pyx_v_userId = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_userId == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 90, __pyx_L3_error)
    __pyx_v_Theta_zh = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4]); if (unlikely(!__pyx_v_Theta_zh.memview)) __PYX_ERR(0, 90, __pyx_L3_error)
    __pyx_v_Psi_zss = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[5]); if (unlikely(!__pyx_v_Psi_zss.memview)) __PYX_ERR(0, 90, __pyx_L3_error)
    __pyx_v_a = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_a == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 90, __pyx_L3_error)
    __pyx_v_s = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_s == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 90, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calculateSequenceProb_trpp", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 90, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("myCython.cythonOptimize.calculateSequenceProb_trpp", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8myCython_14cythonOptimize_8calculateSequenceProb_trpp(__pyx_self, __pyx_v_theSequence, __pyx_v_theSequenceLen, __pyx_v_logSeqProbZ, __pyx_v_userId, __pyx_v_Theta_zh, __pyx_v_Psi_zss, __pyx_v_a, __pyx_v_s);
...
static PyObject *__pyx_pf_8myCython_14cythonOptimize_8calculateSequenceProb_trpp(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_theSequence, int __pyx_v_theSequenceLen, __Pyx_memviewslice __pyx_v_logSeqProbZ, int __pyx_v_userId, __Pyx_memviewslice __pyx_v_Theta_zh, __Pyx_memviewslice __pyx_v_Psi_zss, double __pyx_v_a, int __pyx_v_s) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("calculateSequenceProb_trpp", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_theSequence.memview)) { __Pyx_RaiseUnboundLocalError("theSequence"); __PYX_ERR(0, 90, __pyx_L1_error) }
  if (unlikely(!__pyx_v_logSeqProbZ.memview)) { __Pyx_RaiseUnboundLocalError("logSeqProbZ"); __PYX_ERR(0, 90, __pyx_L1_error) }
  if (unlikely(!__pyx_v_Theta_zh.memview)) { __Pyx_RaiseUnboundLocalError("Theta_zh"); __PYX_ERR(0, 90, __pyx_L1_error) }
  if (unlikely(!__pyx_v_Psi_zss.memview)) { __Pyx_RaiseUnboundLocalError("Psi_zss"); __PYX_ERR(0, 90, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_8myCython_14cythonOptimize_calculateSequenceProb_trpp(__pyx_v_theSequence, __pyx_v_theSequenceLen, __pyx_v_logSeqProbZ, __pyx_v_userId, __pyx_v_Theta_zh, __pyx_v_Psi_zss, __pyx_v_a, __pyx_v_s, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 90, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_logSeqProbZ, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_Theta_zh, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_Psi_zss, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "myCython.cythonOptimize.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "myCython.cythonOptimize.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "myCython.cythonOptimize.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "myCython.cythonOptimize._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"getLogProb", (PyCFunction)__pyx_pw_8myCython_14cythonOptimize_1getLogProb, METH_VARARGS|METH_KEYWORDS, 0},
  {"evaluate", (PyCFunction)__pyx_pw_8myCython_14cythonOptimize_3evaluate, METH_VARARGS|METH_KEYWORDS, 0},
  {"calculateSequenceProb", (PyCFunction)__pyx_pw_8myCython_14cythonOptimize_5calculateSequenceProb, METH_VARARGS|METH_KEYWORDS, 0},
  {"doSum", (PyCFunction)__pyx_pw_8myCython_14cythonOptimize_7doSum, METH_VARARGS|METH_KEYWORDS, 0},
  {"calculateSequenceProb_trpp", (PyCFunction)__pyx_pw_8myCython_14cythonOptimize_9calculateSequenceProb_trpp, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_Psi_zss, __pyx_k_Psi_zss, sizeof(__pyx_k_Psi_zss), 0, 0, 1, 1},
 ...
 *         from pickle import PickleError
 */
  __pyx_tuple__25 = PyTuple_Pack(5, __pyx_n_s_pyx_type, __pyx_n_s_pyx_checksum, __pyx_n_s_pyx_state, __pyx_n_s_PickleError, __pyx_n_s_result); if (unlikely(!__pyx_tuple__25)) __PYX_ERR(1, 1, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcythonOptimize(void); /*proto*/
PyMODINIT_FUNC initcythonOptimize(void)
#else
PyMODINIT_FUNC PyInit_cythonOptimize(void); /*proto*/
PyMODINIT_FUNC PyInit_cythonOptimize(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cythonOptimize(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cythonOptimize", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_myCython__cythonOptimize) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "myCython.cythonOptimize")) {
      if (unlikely(PyDict_SetItemString(modules, "myCython.cythonOptimize", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init myCython.cythonOptimize", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init myCython.cythonOptimize");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
