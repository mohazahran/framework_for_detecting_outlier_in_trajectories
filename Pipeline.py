...
def selectThresholdPipeline():
    ...
    inj = InjectOutliers()
    #common
    inj.INPUT_FILE = '/scratch/snyder/m/mohame11/pins_repins_win4_fixedcat/simulatedData_injected/pins_repins_bbtt3_simulatedData_fixed_3_injected'
    inj.OUTPUT_FILE = ''
    ...
    detect.RESULTS_PATH = detect.PATH+'/simulatedData_injected/pvalues_rnnlm3'
    detect.SEQ_FILE_PATH = detect.PATH+'/simulatedData_injected/pins_repins_bbtt3_simulatedData_fixed_3_injected'
    ...
    select.INPUT_PATH = '/Users/mohame11/Desktop/pvalues_rnnlm3'
